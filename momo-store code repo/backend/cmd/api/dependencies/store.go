	...
	packs := []dumplings.Product{
		{
			...
			Price:       5.00,
			Image:       "https://storage.yandexcloud.net/antmartss3momo/1.jpg",
		},
		{
			ID:          2,
			Name:        "Хинкали",
			...
			Price:       3.50,
			Image:       "https://storage.yandexcloud.net/antmartss3momo/2.jpg",
		},
		{
			ID:          3,
			Name:        "Манты",
			...
			Price:       2.75,
			Image:       "https://storage.yandexcloud.net/antmartss3momo/3.jpg",
		},
		{
			ID:          4,
			Name:        "Буузы",
			...
			Price:       4.00,
			Image:       "https://storage.yandexcloud.net/antmartss3momo/4.jpg",
		},
		{
			ID:          5,
			Name:        "Цзяоцзы",
			...
			Price:       7.25,
			Image:       "https://storage.yandexcloud.net/antmartss3momo/5.jpg",
		},
		{
			ID:          6,
			Name:        "Гедза",
			...
			Price:       3.50,
			Image:       "https://storage.yandexcloud.net/antmartss3momo/6.jpg",
		},
		{
			ID:          7,
			Name:        "Дим-самы",
			Description: "С уткой",
			Price:       2.65,
			Image:       "https://storage.yandexcloud.net/antmartss3momo/7.jpg",
		},
		{
			ID:          8,
			Name:        "Момо",
			...
			Price:       5.00,
			Image:       "https://storage.yandexcloud.net/antmartss3momo/8.jpg",
		},
		{
			ID:          9,
			Name:        "Вонтоны",
